...
![设置网址](/images/build_own_website/modifywebsite.png)
...
- ### 修改 README.md 文件
    ...
    README.md 是项目/仓库的自述文件，一般来说第一行标题是仓库名称，后面就是关于仓库的一些介绍或配置说明。对于个人博客仓库来说，README.md 的内容是比较自由的，可以根据你自己的情况来写，或者不写也无妨，它并不影响我们的网站页面。
...
- ### 修改 _config.yml 文件
    ...
    - **网站标题和网站描述**
        ...
        ![标题和描述](/images/build_own_website/title&desc.png)
    ...
    - **个人头像和网站 logo**
        ...
        ![PicGo 配置](/images/build_own_website/picgoconfiguration.png)

    - **个人社交链接**

        ![社交链接](/images/build_own_website/links.png)

        填用户名就好，也可以不填。

    - **脚注和网址**

        ![版权标注和网址](/images/build_own_website/footer&url.png)
...
好了，以上就是所有必须要你修改的文件。你现在再点进去你的博客页面刷新一下，不出意外的话应该是成功修改了的。
