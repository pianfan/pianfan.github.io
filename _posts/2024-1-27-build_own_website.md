...
利用 GitHub Pages 免费获取你自己的网站域名只需要一个先决条件：拥有你自己的 github 账号。如果你目前还没有，可以去 [GitHub 官网](https://github.com)先注册一个。国内一般情况下是访问不了 GitHub 的，你可能需要采取一些手段，读者可以自行在网上搜索，例如“国内如何合法访问github”，笔者这里就不再详述了。但是要提醒一句，一定要在**合法**范围内访问外网，如果你不能保证，请不要尝试。
